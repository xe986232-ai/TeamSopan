      ...
      >
        ...
        <div className="flex items-center gap-4 mt-2">
          <a
            ...
            aria-label="Discord"
            className="flex h-10 w-10 items-center justify-center rounded-full text-ink-muted hover:text-ink hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
          >
          ...
          <a
            href="https://www.tiktok.com/@sopanteam"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="flex h-10 w-10 items-center justify-center rounded-full text-ink-muted hover:text-ink hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
