// Frame device iPhone 15 Pro (SVG) -- dikonversi dari versi TypeScript
// (Magic UI style) ke JS biasa karena project ini nggak pakai TypeScript
// (lihat jsconfig.json). Ditambah 1 fitur baru: prop `children` -- kalau
// diisi, kontennya dirender HIDUP (bukan gambar statis) di dalam layar HP
// lewat <foreignObject>, jadi komponen React beneran (kayak NowPlayingCard)
