        ...
        {items.map((item) => (
          ...
          >
            ...
            <button
              ...
              className="shrink-0 text-sm font-medium px-4 py-1.5 rounded-full bg-ink-solid text-white dark:bg-white dark:text-ink-solid hover:opacity-80 transition-opacity"
            >
              Play
            </button>
          </motion.li>
